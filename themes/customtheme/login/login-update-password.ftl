...
<head>
    ...
    <style>
        ...
        .container { max-width: 400px; margin: 40px auto; background: #fff; padding: 2em 2em 1em 2em; border-radius: 8px; box-shadow: 0 0 10px #ccc;}
        form { display: flex; flex-direction: column; }
        label { margin-bottom: 4px; }
        input[type=password] { margin-bottom: 16px; padding: 8px; border: 1px solid #bbb; border-radius: 4px;}
        input[type=submit] { padding: 10px; background: #316be1; color: white; border: none; border-radius: 4px; cursor: pointer; font-weight: bold;}
        input[type=submit]:hover { background: #224599;}
        .header { text-align: center; margin-bottom: 24px; }
        .error { color: #ae1c17; font-size: 0.95em; margin-bottom: 1em; }
    </style>
</head>
<body>
    <div class="container">
